...
def generate_launch_description():
    ...
    default_model_path = os.path.join(descr_pkg_share, "urdf/spotmicroai.urdf.xacro")
    ...
    # 1. Start the permanent background interceptor dynamically regardless of Docker mounting
    # interceptor_node = Node(
    #     package='spotmicro_config',
    #     executable='invert_vel.py',
    #     name='velocity_inverter',
    #     output='screen'
    # )

    # 2. Wrap the CHAMP brain so it only listens to the hidden intercepted topic
    # champ_brain_group = GroupAction([
    #     SetRemap(src='/cmd_vel', dst='/robotA/cmd_vel'),
    #     bringup_ld
    # ])
